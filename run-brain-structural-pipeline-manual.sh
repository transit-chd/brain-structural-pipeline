...
Example container usage:
  singularity exec --bind \$INPUT_DIR:/home/data/input,\$OUTPUT_DIR:/home/data/output,\$TEMP_DIR:/home/tmp_proc svrtk-auto.sif /bin/sh -c "/home/scripts/run-brain-structural-pipeline-manual.sh \$STACK_SLICE_THICKNESS"
...
# Manual SVR
#if only slice thickness or nothing, only mask is diff

#if other things specified
